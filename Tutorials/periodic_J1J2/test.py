...
RNNEnergy, varRNNEnergy = run_J1J2(numsteps = 10000, systemsize = 16, J1_  = 1.0, J2_ = 0.2, Marshall_sign = False, num_units = 10, num_layers = 1, numsamples = numsamples, learningrate = 5e-4, seed = 111)
