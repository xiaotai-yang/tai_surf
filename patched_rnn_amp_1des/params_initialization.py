...
def init_RWKV_params(emb_size, h_size, num_layer, out_h_size, out_size, N, key):
    ...
    return (x_init, t_init, c_init, wln_in, bln_in, wln_out, bln_out, whead, bhead, wprob1, bprob1, wprob2, bprob2, RWKV_cell_params)
...
def RWKV_step(x, t_states, c_states, num_layer, RWKV_net_params, indices):
    n = indices
    w_in, b_in, whead, bhead, wln_out, bln_out, wprob1, bprob1, wprob2, bprob2, RWKV_cell_params = RWKV_net_params
