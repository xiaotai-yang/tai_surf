from TrainingRNN_random import run_
...
RNNEnergy, varRNNEnergy = run_(numsteps = 10000, systemsize = 32, num_units = 64, num_layers = 2, numsamples = 128, learningrate = 0.0005, seed = 113)
