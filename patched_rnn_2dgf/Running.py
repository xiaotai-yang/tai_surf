...
parser.add_argument('--Nconvergence', type = int, default=2)
...
for angle in (0., ):
    ...
    params = params_init(rnn_type, Nx, Ny, units, input_size, key)
    ...
    for it in range(0, numsteps):
        ...
        '''
        t0 = time.time()
        samples, sample_log_amp = vmap(sample_prob, (None, None, None, 0))(params, fixed_params, ny_nx_indices, sample_key)
        ...
        log_all_amp = vmap(log_amp, (0, None, None, None))(sigmas, params, fixed_params, ny_nx_indices)
