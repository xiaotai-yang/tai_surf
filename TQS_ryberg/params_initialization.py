...
def init_transformer_params(T, ff_size, units, input_size, head, key):
    ...
    key_encode, key_i, keyq, keyk, keyv, keyo, keyfh, keyhf, keyhh, keyho = random.split(key, 10)
    ...
    Whh, bhh = i1(keyhh,(units, units)), jnp.zeros((units))
    ...
    return (Wemb, Wi, bi, Wq, bq, Wk, bk, Wv, bv, Wo, bo, a1, a2, b1, b2, Wfh, bfh, Whf, bhf, Whh, bhh, Who1, bho1)
...
def TF_step(x, loc, num_layer, params):
    ...
    (Wemb, Wi, bi, Wq, bq, Wk, bk, Wv, bv, Wo, bo, a1, a2, b1, b2, Wfh, bfh, Whf, bhf, Whh, bhh, Who1, bho1) = params
