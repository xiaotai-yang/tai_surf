...
def init_RWKV_params(input_size, emb_size, h_size,  num_layer, out_size, Ny, Nx, key):
    ...
    wprob, bprob = jnp.zeros((Ny, Nx, out_size, emb_size)), jnp.zeros((Ny, Nx, out_size))
    ...
    return (x_init, y_init, t_last_x1_init, t_last_x2_init, t_last_y1s_init, t_last_y1e_init, t_last_y2_init,
            c_last_x1_init, c_last_x2_init, c_last_y1s_init, c_last_y1e_init, c_last_y2_init,  wln_in, bln_in,
            wln_out, bln_out, whead, bhead, wprob, bprob, RWKV_cell_params)
def logaddexp(a, b):
...
def time_mixing(x, t_state, decay, bonus, t_mix_k, t_mix_v, t_mix_r, t_wlast_x, Wk, Wv, Wr, Wout, t_xout, t_alphaout, t_betaout):
    ...
    beta = jnp.logaddexp(t_betaout @ beta - 0.3, t_betaout @ beta - 0.3)
...
def RWKV_step(x, t_states, c_states, num_layer, RWKV_net_params, indices):
    ny, nx = indices
    w_in, b_in, whead, bhead, w_out, b_out, wprob, bprob, RWKV_cell_params = RWKV_net_params
